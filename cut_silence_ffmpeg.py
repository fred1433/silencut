#!/usr/bin/env python3
"""
Version légère utilisant uniquement FFmpeg pour la détection de silence
Conçu pour fonctionner avec 512MB de RAM
"""
...
def process_video(input_file: str, output_file: str, **kwargs):
    """Interface simple pour traiter une vidéo"""
    ...
    processor = FFmpegVideoProcessor(crf=kwargs.get('crf', 18))
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 3:
        print("Usage: python cut_silence_ffmpeg.py input.mp4 output.mp4")
        sys.exit(1)
    
    input_file = sys.argv[1]
    output_file = sys.argv[2]
    
    segments = process_video(input_file, output_file)
